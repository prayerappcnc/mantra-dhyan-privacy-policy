        ...
        <li><h3>Information We Collect</h3>
            ...
            <ul>
                <li>
                    ...
                    <p>This information is collected only during sign‑up for account identification and communication purposes.</p><div class="spacer10"></div>
                </li>
                <li>
...
<style>
    ...
    .privacy_policy h3{
        font-size:22px;font-weight: 500;line-height:30px;padding:0px 0px 0px 0px;margin:20px 0px 0px 0px;
    }
    .privacy_policy h4{
    ...
    .privacy_policy ul{margin-bottom:20px;}
